from .optimized_curve import multiply
from .constants import H_EFF
...
def multiply_clear_cofactor_G2(p: Optimized_Point3D[Optimized_Field]) -> Optimized_Point3D[Optimized_Field]:
